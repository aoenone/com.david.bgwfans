...
public class ParkMap extends RoboSherlockFragment {
...
//    private Marker eita;
    ...
    private static final LatLng BigBen = new LatLng(37.236163, -76.645788);
    private Marker Big_Ben;

    private static final LatLng DaVinciGardens = new LatLng(37.234623,-76.643616);
    private Marker DaVinci_Gardens;

    private static final LatLng MayPole = new LatLng(37.231582,-76.646258);
    private Marker May_Pole;

    private static final LatLng GermanyFountain = new LatLng(37.233124,-76.646752);
    private Marker Germany_Fountain;

    private static final LatLng IrelandWaterfall = new LatLng(37.236163,-76.647962);
    private Marker Ireland_Waterfall;
    ...
    private static final LatLng MAPpoint = new LatLng(37.236138,-76.642127);
...
//        setRetainInstance(true);
    ...
    public void addLandmarks(){
    	...
    	Big_Ben = mMap.addMarker(new MarkerOptions()
        .position(BigBen)
        .title("Big Ben"));

    	DaVinci_Gardens = mMap.addMarker(new MarkerOptions()
        .position(DaVinciGardens)
        .title("DaVinci's Gardens"));

    	May_Pole = mMap.addMarker(new MarkerOptions()
        .position(MayPole)
        .title("Oktoberfest MayPole"));

    	Germany_Fountain = mMap.addMarker(new MarkerOptions()
        .position(GermanyFountain)
        .title("Germany Fountain"));

    	Ireland_Waterfall = mMap.addMarker(new MarkerOptions()
        .position(IrelandWaterfall)
        .title("Ireland Waterfall"));
    }

  /**  public void addMapOverlay(){

    	mGroundOverlay = mMap.addGroundOverlay(new GroundOverlayOptions()
    				.image(BitmapDescriptorFactory.fromResource(R.drawable.mapoverlay))
    				.position(MAPpoint, 1138f, 600f));
    } **/
