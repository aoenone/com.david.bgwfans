...
public class Smokehouse extends FragmentActivity implements View.OnClickListener {
    private GoogleMap mMap;
    public WebView webViewWiki;

    static final CameraPosition HOME =
            new CameraPosition.Builder().target(new LatLng(37.23381, -76.648819))
                    .zoom(17)
                    .bearing(0)
                    .tilt(25)
                    .build();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.smokehouse);
        setUpMapIfNeeded();
    ...
    private void setUpMap() {
        mMap.addMarker(new MarkerOptions().position(new LatLng(37.23381, -76.648819)).title("Trappers Smokehouse"));
    ...
    public void Wiki(View view) {
        ...
        i.putExtra("wikiLink", "http://wiki.parkfans.net/index.php/Trappers_Smokehouse");
        startActivity(i);
    }
