...
public class WaterFragment extends SherlockFragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        attractions.add(new Attractions("Stanley Falls", R.drawable.deadline));
        attractions.add(new Attractions("Tanganyaika Tidal Wave", R.drawable.demonstreet));
        attractions.add(new Attractions("Congo River Rapids", R.drawable.demonstreet));
    }
