 ...
 */
public class Gloria extends RoboSherlockFragmentActivity {

    XmasItem forum;
    GoogleMap mMap;
    private static final LatLng LOC_BITTEN = new LatLng(37.236094,-76.647996);
    ...
    public void onCreate(Bundle savedInstanceState){
        ...
        FadingHelper helper = new FadingHelper()
                ...
                .parallax(true)
                .contentLayout(R.layout.xmas_gloria);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.menu_item_share:
                ...
                sendIntent.putExtra(Intent.EXTRA_TEXT, "I'm at Gloria!, via the BGWFans for Android app! " + "https://play.google.com/store/apps/details?id=com.david.bgwfans");
