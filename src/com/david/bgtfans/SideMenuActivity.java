...
import com.david.bgtfans.fragments.BGWFans;
...
import com.david.bgtfans.webviews.ChatRoom;
...
//            startActivity(attrActivity);
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        chatroomButton = (TextView) findViewById(R.id.chatroom);
        chatroomButton.setOnLongClickListener(new OnLongClickListener(){

			@Override
			public boolean onLongClick(View v) {
				Intent cr = new Intent(getApplicationContext(), ChatRoom.class);
                startActivity(cr);
                return true;
			}
