 ...
 *
 * Forked and making some changes to possibly work better with the new 4.4 status bar
 */
...
import com.david.bgwfanspaid.utils.fadingScroller.NotifyScrollView;
...
public class FadingHelper {
    ...
    public FadingHelper actionBarBackground(int drawableResId) {
        mActionBarBackgroundResId = drawableResId;
        return this;
    }

    public FadingHelper actionBarBackground(Drawable drawable) {
        mActionBarBackgroundDrawable = drawable;
        return this;
    }

    public FadingHelper headerLayout(int layoutResId) {
        mHeaderLayoutResId = layoutResId;
        return this;
    }

    public FadingHelper headerView(View view) {
        mHeaderView = view;
        return this;
    }
     ...
     */
    public FadingHelper headerOverlayLayout(int layoutResId) {
     ...
     */
    public FadingHelper headerOverlayView(View view) {
        mHeaderOverlayView = view;
        return this;
    }

    public FadingHelper contentLayout(int layoutResId) {
        mContentLayoutResId = layoutResId;
        return this;
    }

    public FadingHelper contentView(View view) {
        mContentView = view;
        return this;
    }

    public FadingHelper lightActionBar(boolean value) {
        mLightActionBar = value;
        return this;
    }

    public FadingHelper parallax(boolean value) {
        mUseParallax = value;
        return this;
    }
    ...
    private View createScrollView() {
        ...
        NotifyScrollView scrollView = (NotifyScrollView) mScrollView.findViewById(R.id.fab__scroll_view);
    ...
    private NotifyScrollView.OnScrollChangedListener mOnScrollChangedListener = new NotifyScrollView.OnScrollChangedListener() {
