...
public class Mach extends FragmentActivity implements View.OnClickListener {
    private GoogleMap mMap;
    public WebView webViewWiki;

    static final CameraPosition HOME =
            new CameraPosition.Builder().target(new LatLng(37.232588, -76.645552))
                    .zoom(17)
                    .bearing(0)
                    .tilt(25)
                    .build();
    ...
    private void setUpMap() {
        mMap.addMarker(new MarkerOptions().position(new LatLng(37.232588, -76.645552)).title("Mach Tower"));
    ...
    public void Wiki(View view) {
        ...
        i.putExtra("wikiLink", "http://wiki.parkfans.net/index.php/Mach_Tower");
        startActivity(i);
    }
