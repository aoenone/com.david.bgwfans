...
public class FlyingMachine extends FragmentActivity implements View.OnClickListener {
    private GoogleMap mMap;
    public WebView webViewWiki;

    static final CameraPosition HOME =
            new CameraPosition.Builder().target(new LatLng(37.234747, -76.643374))
                    .zoom(17)
                    .bearing(0)
                    .tilt(25)
                    .build();
    ...
    private void setUpMap() {
        mMap.addMarker(new MarkerOptions().position(new LatLng(37.234747, -76.643374)).title("Flying Machine"));
