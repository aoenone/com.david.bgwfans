...
public class EITA extends FragmentActivity implements View.OnClickListener {
    private GoogleMap mMap;
    public WebView webViewWiki;

    static final CameraPosition HOME =
            new CameraPosition.Builder().target(new LatLng(37.235983, -76.64745))
                    .zoom(17)
                    .bearing(0)
                    .tilt(25)
                    .build();
    ...
    private void setUpMap() {
        mMap.addMarker(new MarkerOptions().position(new LatLng(37.235983, -76.64745)).title("Europe in the Air"));
    ...
    public void Wiki(View view) {
        ...
        i.putExtra("wikiLink", "http://wiki.parkfans.net/index.php/Europe_In_The_Air");
        startActivity(i);
    }
