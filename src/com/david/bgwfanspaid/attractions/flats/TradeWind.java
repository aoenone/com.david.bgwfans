...
public class TradeWind extends FragmentActivity implements View.OnClickListener {
    private GoogleMap mMap;
    public WebView webViewWiki;

    static final CameraPosition HOME =
            new CameraPosition.Builder().target(new LatLng(37.234394, -76.642012))
                    .zoom(17)
                    .bearing(0)
                    .tilt(25)
                    .build();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.tradewind);
        setUpMapIfNeeded();
    ...
    private void setUpMap() {
        mMap.addMarker(new MarkerOptions().position(new LatLng(37.234394, -76.642012)).title("Trade Wind"));
    ...
    public void Wiki(View view) {
        ...
        i.putExtra("wikiLink", "http://wiki.parkfans.net/index.php/The_Trade_Wind");
        startActivity(i);
    }
