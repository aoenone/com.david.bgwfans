...
public class Catapult extends FragmentActivity implements View.OnClickListener {
    ...
    static final CameraPosition HOME =
            new CameraPosition.Builder().target(new LatLng(37.233352, -76.649015))
                    .zoom(17)
                    .bearing(0)
                    .tilt(25)
                    .build();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.catapult);
        setUpMapIfNeeded();
    ...
    private void setUpMap() {
        mMap.addMarker(new MarkerOptions().position(new LatLng(37.233352, -76.649015)).title("Le Catapult"));
    ...
    public void Wiki(View view) {
        ...
        i.putExtra("wikiLink", "http://wiki.parkfans.net/index.php/Le_Catapult");
        startActivity(i);
    }
