...
public class AutoBahn extends FragmentActivity implements View.OnClickListener {
    private GoogleMap mMap;
    public WebView webViewWiki;

    static final CameraPosition HOME =
            new CameraPosition.Builder().target(new LatLng(37.231535, -76.645713))
                    .zoom(17)
                    .bearing(0)
                    .tilt(25)
                    .build();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.autobahn);
        setUpMapIfNeeded();
    ...
    private void setUpMap() {
        mMap.addMarker(new MarkerOptions().position(new LatLng(37.231535, -76.645713)).title("Die AutoBahn"));
    ...
    public void Wiki(View view) {
        ...
        i.putExtra("wikiLink", "http://wiki.parkfans.net/index.php/Die_Autobahn");
        startActivity(i);
    }
