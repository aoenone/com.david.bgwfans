...
public class Flume extends FragmentActivity implements View.OnClickListener {
    private GoogleMap mMap;
    public WebView webViewWiki;

    static final CameraPosition HOME =
            new CameraPosition.Builder().target(new LatLng(37.233046, -76.648452))
                    .zoom(17)
                    .bearing(0)
                    .tilt(25)
                    .build();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.lescoot);
        setUpMapIfNeeded();
    ...
    private void setUpMap() {
        mMap.addMarker(new MarkerOptions().position(new LatLng(37.233046, -76.648452)).title("Le Scoot"));
    ...
    public void Wiki(View view) {
        ...
        i.putExtra("wikiLink", "http://wiki.parkfans.net/index.php/Le_Scoot");
        startActivity(i);
    }
