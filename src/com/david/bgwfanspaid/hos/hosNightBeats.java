 ...
 */
public class hosNightBeats extends RoboSherlockFragmentActivity {
    ...
    static final CameraPosition HOME =
            new CameraPosition.Builder().target(LOC_NIGHT)
                    .zoom(17)
                    .bearing(0)
                    .tilt(25)
                    .build();
    @InjectView (R.id.nightbeats_forum) AttractionItem nightBeatsForum;
    ...
    public void onCreate(Bundle savedInstanceState){
        ...
        FadingActionBarHelper helper = new FadingActionBarHelper()
                ...
                .headerLayout(R.layout.hos_nightbeats_header)
                .parallax(true)
                .contentLayout(R.layout.hos_nightbeats_2013);

        setContentView(helper.createView(this));
        helper.initActionBar(this);
        setUpMapIfNeeded();

        nightBeatsForum.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(getApplicationContext(), HiddenWiki.class);
                i.putExtra("wikiLink", "http://forum.parkfans.net/thread-1448.html");
                startActivity(i);
            }
        });
    }
