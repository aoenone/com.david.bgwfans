 ...
 */
public class hosCove extends RoboSherlockFragmentActivity {

    GoogleMap mMap;
    private static final LatLng LOC_COVE = new LatLng(37.234301,-76.641639);
    private Marker cove;
    static final CameraPosition HOME =
            new CameraPosition.Builder().target(LOC_COVE)
                    .zoom(17)
                    .bearing(0)
                    .tilt(25)
                    .build();

    @InjectView (R.id.cove_forum)
    AttractionItem coveForum;
    ...
    public void onCreate(Bundle savedInstanceState){
        ...
        FadingActionBarHelper helper = new FadingActionBarHelper()
                ...
                .parallax(true)
                .contentLayout(R.layout.hos_cove_2013);

        setContentView(helper.createView(this));
        helper.initActionBar(this);
        setUpMapIfNeeded();

        coveForum.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(getApplicationContext(), HiddenWiki.class);
                i.putExtra("wikiLink", "http://forum.parkfans.net/thread-2389.html");
                startActivity(i);
            }
        });
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.menu_item_share:
                ...
                sendIntent.putExtra(Intent.EXTRA_TEXT, "I'm at Cut Throat Cove, via the BGWFans for Android app! " + "https://play.google.com/store/apps/details?id=com.david.bgwfanspaid");
    ...
    private void setUpMap() {
        cove = mMap.addMarker(new MarkerOptions()
                ...
                .snippet("The haven for bloodthirsty, dangerous rouges - where the scurvy dogs, " +
                        "buccaneers and scoundrels go for shelter"));
