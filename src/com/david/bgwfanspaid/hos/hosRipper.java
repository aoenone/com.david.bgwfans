 ...
 */
public class hosRipper extends RoboSherlockFragmentActivity {
    ...
    @InjectView(R.id.ripper_forum)
    AttractionItem ripperForum;
    ...
    public void onCreate(Bundle savedInstanceState){
        ...
        FadingActionBarHelper helper = new FadingActionBarHelper()
                ...
                .parallax(true)
                .contentLayout(R.layout.hos_ripper_2013);

        setContentView(helper.createView(this));
        helper.initActionBar(this);
        setUpMapIfNeeded();

        ripperForum.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.menu_item_share:
                ...
                sendIntent.putExtra(Intent.EXTRA_TEXT, "I'm at Ripper Row, via the BGWFans for Android app! " + "https://play.google.com/store/apps/details?id=com.david.bgwfans");
