package com.david.bgwfanspaid.xmas;
...
public class HolidayHills extends RoboSherlockFragmentActivity {
    ...
    @InjectView(R.id.bitten_forum)
    AttractionItem bittenForum;
    ...
    public void onCreate(Bundle savedInstanceState){
        ...
        FadingActionBarHelper helper = new FadingActionBarHelper()
                ...
                .headerLayout(R.layout.header_pager_holder)
                .parallax(true)
                .contentLayout(R.layout.hos_bitten_2013);

        setContentView(helper.createView(this));
        helper.initActionBar(this);
        setUpMapIfNeeded();

        bittenForum.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(getApplicationContext(), HiddenWiki.class);
                i.putExtra("wikiLink", "http://forum.parkfans.net/thread-2323.html");
                startActivity(i);
            }
        });
    }
