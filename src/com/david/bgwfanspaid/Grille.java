...
public class Grille extends FragmentActivity implements View.OnClickListener {
    private GoogleMap mMap;
    public WebView webViewWiki;

    static final CameraPosition HOME =
            new CameraPosition.Builder().target(new LatLng(37.236133, -76.645618))
                    .zoom(17)
                    .bearing(0)
                    .tilt(25)
                    .build();
    ...
    private void setUpMap() {
        mMap.addMarker(new MarkerOptions().position(new LatLng(37.236133, -76.645618)).title("Squire's Grille"));
    ...
    public void Wiki(View view) {
        ...
        i.putExtra("wikiLink", "http://wiki.parkfans.net/index.php/Squire%27s_Grille");
        startActivity(i);
    }
