package com.david.bgwfans.utils;
...
public class BlurToggle implements DrawerToggle{
    ...
    public BlurToggle(Activity a, DrawerLayout d, View behindDrawer, int gravity, int blurRadius){
        this(a,d,behindDrawer,gravity);
        mBlurRadius = blurRadius;
    }

    public BlurToggle(Activity a, DrawerLayout d, final View behindDrawer, int gravity){
        mActivity = a;
        mDrawerLayout = d;
