package com.david.bgwfans.xmas.attractions;
 ...
 */
public class PolarPathway extends RoboSherlockFragmentActivity {

    XmasItem mistleForum;
    GoogleMap mMap;
    private static final LatLng LOC_BITTEN = new LatLng(37.235689,-76.644305);
    ...
    public void onCreate(Bundle savedInstanceState){
        ...
        FadingHelper helper = new FadingHelper()
                ...
                .parallax(true)
                .contentLayout(R.layout.xmas_polar_pathway);

        setContentView(helper.createView(this));
        helper.initActionBar(this);
        setUpMapIfNeeded();

        mistleForum = (XmasItem) findViewById(R.id.polar_forum);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.menu_item_share:
                ...
                sendIntent.putExtra(Intent.EXTRA_TEXT, "I'm at Polar Pathway, via the BGWFans for Android app! " + "https://play.google.com/store/apps/details?id=com.david.bgwfans");
