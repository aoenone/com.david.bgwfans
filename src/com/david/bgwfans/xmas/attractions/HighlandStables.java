 ...
 */
public class HighlandStables extends RoboSherlockFragmentActivity {

    XmasItem forum;
    GoogleMap mMap;
    private static final LatLng LOC_BITTEN = new LatLng(37.235398,-76.646054);
    ...
    public void onCreate(Bundle savedInstanceState){
        ...
        FadingHelper helper = new FadingHelper()
                ...
                .parallax(true)
                .contentLayout(R.layout.xmas_highland);

        setContentView(helper.createView(this));
        helper.initActionBar(this);
        setUpMapIfNeeded();

        forum = (XmasItem) findViewById(R.id.highland_forum);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.menu_item_share:
                ...
                sendIntent.putExtra(Intent.EXTRA_TEXT, "I'm at Highland Stables, via the BGWFans for Android app! " + "https://play.google.com/store/apps/details?id=com.david.bgwfans");
