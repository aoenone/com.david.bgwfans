 ...
 */
public class HolidayHills extends RoboSherlockFragmentActivity {

    XmasItem forum;
    GoogleMap mMap;
    private static final LatLng LOC_BITTEN = new LatLng(37.234467,-76.642219);
    ...
    public void onCreate(Bundle savedInstanceState){
        ...
        FadingHelper helper = new FadingHelper()
                ...
                .parallax(true)
                .contentLayout(R.layout.xmas_holiday_hills);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.menu_item_share:
                ...
                sendIntent.putExtra(Intent.EXTRA_TEXT, "I'm at Holiday Hills, via the BGWFans for Android app! " + "https://play.google.com/store/apps/details?id=com.david.bgwfans");
