...
import com.david.bgwfans.hos.HOSHouses;
import com.david.bgwfans.hos.HOSInfo;
import com.david.bgwfans.hos.HOSMap;
import com.david.bgwfans.hos.HOS_Culinary;
import com.david.bgwfans.hos.HOS_Shows;
import com.david.bgwfans.hos.HOS_TERROR;
import com.david.bgwfans.hos.HosShows;
    ...
    private void setContentFragment(int fragID){
        ...
        switch (fragID){
            ...
            case NAV_HOS_CULINARY:
                fragment = injector.getInstance(HOS_Culinary.class); //TODO
                break;
            case NAV_HOS_EXP:
                fragment = injector.getInstance(HOS_TERROR.class); //TODO
                break;
            case NAV_HOS_MAP:
