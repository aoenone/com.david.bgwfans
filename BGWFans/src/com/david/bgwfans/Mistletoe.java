...
public class Mistletoe extends SideMenuActivity implements View.OnClickListener {
	...
	setContentView(R.layout.mistletoe);
    ...
    GeoPoint point = new GeoPoint((int)(37.231808*1E6),(int)(-76.646336*1E6));
