...
public class Palace extends BaseActivity implements View.OnClickListener {
	...
	setContentView(R.layout.palace);
    ...
    GeoPoint point = new GeoPoint((int)(37.234615*1E6),(int)(-76.649014*1E6));
    OverlayItem overlayitem = new OverlayItem(point, "Ice Palace: A Penguin Paradise", "Ice-themed World");
